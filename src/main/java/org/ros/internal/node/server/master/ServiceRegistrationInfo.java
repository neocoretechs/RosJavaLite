...
public class ServiceRegistrationInfo {
   ...
   */
  private final InetSocketAddress serviceUri;
  ...
  public ServiceRegistrationInfo(GraphName serviceName, InetSocketAddress inetSocketAddress, NodeRegistrationInfo node) {
    this.serviceName = serviceName;
    this.serviceUri = inetSocketAddress;
    this.node = node;
  }
  ...
  /**
   * Get the InetAddress of the service server.
   * 
   * @return the service InetAddress
   */
  public InetSocketAddress getServiceUri() {
    return serviceUri;
  }
